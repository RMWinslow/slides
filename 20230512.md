...
$$\sum_{m,t}\lambda(m,e,t,\textcolor{red}{0})\eta(m,e,t)\tau\theta(t)y =
...
$$N_t c_{1t} +  (1-N_t) c_{2t} \leq N_t y$$
...
Solution to SPP is denoted $(c_{1t},c_{2t})$



In the following slides, welfare cost of an equilibrium
is given as $1-\phi$,
...
|:-:|:-:|:-:|:-:|
| No savings, $\pi(0)=0$ | .65, .65, .65, .3 | .9044 | 0.485% |
| No savings, $\pi(0)=1$ | .3, .25, .25., .2 | .94 | 2.4% |
| No savings, no UI | 0,0,0,0 | 0.94 | 0.683% |
| Savings, , $\pi(0)=0$ | .95, 0, 0, .1 | 0.94 | .483% |
