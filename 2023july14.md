...
And time spent for part-time work is calibrated to $\hP=0.225$.
- Half of $\hE$
- Matches CPS data.

$\hP=0.225$ (time Spent for part-time work)

This is equal to 1/2 of 

<!--
TODO: MENTION CALIBRATED SIGMA
-->
...
- $\hP=0.225$ (time Spent for part-time work). Set to half of $\hE$. Close to values seen in CPS.
- Caused weird equilibria.
-->
...
<!--
No Savings, partial UI with $\theta_p=1$, no enforcement ($\pi_p=\pi_u=1$)
...
(Nobody chooses full employment in this case.)

TODO: The above is wrong.-->


<!--
No Savings, optimized partial UI, full enforcement ($\pi_p=\pi_u=0$)

| Optimal $\theta_p,\theta_u,$ | Tax Rate | Employment Rate | Average Utility |
|:------------------:|:--------:|:---------------:|:---------------:|
| 80%,66% | 58% | 89%+5% | -0.5471 |


<img src="img/2023july14/Testing θu. No savings. yP,θp,πp,πu,σ,ρ(0.5, 0.8, 1.0, 1.0, 0.67, 2.5)..png" style="max-width:100%;">
-->
